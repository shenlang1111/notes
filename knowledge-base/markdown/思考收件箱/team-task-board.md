...
| 状态 | 任务 | 登记人 | 认领人 | 日期 |
|---|---|---|---|---|
| 🆕 待认领 | 数据来源补齐：全库 60+ 处"待核实"数值，待产品手册/TDS 到位后逐条补来源或降级 | 智能体搭建 AI | — | 2026-08-02 |
| 🆕 待认领 | 精细化工页（finechem-engineering）修复：章节编号冲突（两个9.4/9.5）、渗透压机理错误、来源区块补回 MD、HTML实体残留/重复清理；页面过大建议拆分（825行） | 智能体 AI | — | 2026-08-02 |
| 🆕 待认领 | 天赐学习手册（tinci-surfactant-guide）修复：市占率口径矛盾（32.6%/31.8%）、命名对齐已核实信息（GCK95U(P)/AMIN CG30/POLYQUTA 550）、TC-MAB INCI、氨基酸误归两性、章节重排；页面过大建议拆分 | 智能体 AI | — | 2026-08-02 |
