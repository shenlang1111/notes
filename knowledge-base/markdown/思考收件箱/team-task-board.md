...
- **强制派活（2026-08-03 用户拍板"你负责调度各个 AI，强制分配"）**：主 AI 调度中枢——待认领项**必须**被派给对应 AI（认领人由主 AI 定），不挂灰；每次派活/汇总向用户转达"什么事情、哪个 AI 做"；任务涉及的事没有对应职责 AI → 主 AI 新建 AI 承担。派活纪律见规范六-2
...
- **状态流转**：🆕 待认领（主 AI 尽快派）→ 🔧 进行中 → ✅ 已完成（完成需 DoD 自检通过）
- **清理**：已完成任务保留 1 个月后归档
